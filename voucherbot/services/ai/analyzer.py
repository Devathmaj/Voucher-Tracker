...
_SYSTEM_PROMPT = (
    ...
    "Set is_voucher=false only when the content is clearly NOT promotional. "
    "Common non-promotional categories:\n"
    "- Exam agreements, candidate agreements, terms of service, legal/contract pages\n"
    "- Policy pages (pricing policies, refund policies, scheduling rules)\n"
    "\n"
    "Everything else — including general certification info, study guides, learning "
    "paths, job postings, and news — should be set is_voucher=true with LOW confidence "
    "(<0.5) if there is even a hint of a discount, free exam, or voucher opportunity.\n"
    "Only set is_voucher=false when you are certain the content has zero promotional "
    "relevance (e.g. a pure legal agreement with no mention of exams, fees, or offers).\n"
