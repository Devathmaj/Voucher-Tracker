...
Revision ID: c684f43a8829
Revises: 
Create Date: 2026-07-06 21:25:22.071420
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('REDDIT', 'RSS', 'WEBSITE', name='sourcetype'), nullable=False),
