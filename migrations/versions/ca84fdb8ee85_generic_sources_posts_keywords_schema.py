...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('REDDIT', 'RSS', 'BLOG', 'EVENT', 'FORUM', 'WEBSITE', 'API', name='sourcetype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('NEW', 'FILTERED', 'QUEUED', 'PROCESSING', 'PROCESSED', 'NOTIFIED', 'FAILED', name='poststatus'), nullable=False),
